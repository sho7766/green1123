...
function menu_in() {
  document.querySelector("header").classList.add("on", "on2");
  ...
  document.querySelector(".lang img").src = "images/country_icon.svg";
...
function menu_out() {
  ...
  gnbA.forEach(function (value, index) {
    ...
    document.querySelector(".lang img").src = "images/country_white_icon.svg";
  });
  sub.forEach(function (value, index) {
    value.classList.remove("on");
  });
...
gnb.forEach(function (value, index) {
  ...
  document.querySelector(".icon").onmouseenter = menu_in;
  document.querySelector(".icon").onmouseleave = menu_out;
});
